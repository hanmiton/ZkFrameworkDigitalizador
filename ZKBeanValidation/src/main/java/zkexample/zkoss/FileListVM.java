...
public class FileListVM implements ConfirmResponse {

	private Center centerArea;
	private Center westArea;
	...
	public void onAddNew() {
		...
		map.put("westArea", westArea);
		
		centerArea.getChildren().clear();
		//falta creacion de file crud
		Executions.createComponents("FileCRUD.zul", centerArea, map);
	...
	public void onConfirmClick(String code, int button) {
		...
		if (code.equals("deleteSecondConfirm") && button == Messagebox.YES) {
			...
			BindUtils.postNotifyChange(null, null, FileListVM.this, "dataSet");
